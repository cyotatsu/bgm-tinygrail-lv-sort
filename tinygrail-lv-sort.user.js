...
// @version      1.0.0
// @description  小圣杯列表按 Lv 排序：适配新版个人主页人物网格与超展开交易榜卡片；悬浮按钮切换升/降序、关闭恢复原顺序；翻页/切标签自动重排
// @author       you
// @match        *://bgm.tv/*
// @match        *://bangumi.tv/*
// @match        *://chii.in/*
...
(function () {
    ...
    function initInWindow(win) {
        ...
        if (!doc) return;
        console.log('[LvSort] 脚本载入:', win.location.href);
        ...
        function collectLists() {
            ...
            for (var i = 0; i < badges.length; i++) add(badges[i].closest(ITEM_SEL));
        ...
        function sortLists() {
            ...
            for (var l = 0; l < lists.length; l++) {
                ...
                console.log('[LvSort] 已排序列表，项数=' + items.length);
            }
        }
